Contributing to BitcoinBrass Core
============================

The BitcoinBrass Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/bitcoinbrass-project/bitcoinbrass/blob/master/doc/translation_process.md)
...
The following applies to code changes to the BitcoinBrass Core project, and is not to be
confused with overall BitcoinBrass Network Protocol consensus changes.

Whether a pull request is merged into BitcoinBrass Core rests with the project merge
...
Patches that change BitcoinBrass consensus rules are considerably more involved than
...
Where a patchset proposes to change the BitcoinBrass consensus, it must have been
...
The project leader is the release manager for each BitcoinBrass Core release.
