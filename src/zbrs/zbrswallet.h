...
#ifndef BitcoinBrass_ZBRSWALLET_H
#define BitcoinBrass_ZBRSWALLET_H
...
public:
    CzBRSWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZBRS(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZBRS(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
...
#endif //BitcoinBrass_ZBRSWALLET_H
