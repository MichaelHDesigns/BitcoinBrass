...
#ifndef BitcoinBrass_ZBRSTRACKER_H
#define BitcoinBrass_ZBRSTRACKER_H
...
public:
    CzBRSTracker(std::string strWalletFile);
    ~CzBRSTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzBRSWallet* zBRSWallet = NULL);
...
#endif //BitcoinBrass_ZBRSTRACKER_H
