...
/* BitcoinBrass GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "BitcoinBrass"
#define QAPP_ORG_DOMAIN "bitcoinbrass.org"
#define QAPP_APP_NAME_DEFAULT "BitcoinBrass-Qt"
#define QAPP_APP_NAME_TESTNET "BitcoinBrass-Qt-testnet"
