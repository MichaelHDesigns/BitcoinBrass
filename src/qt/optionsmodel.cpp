...
// Wallet
    ...
    if (settings.contains("nAnonymizeBitcoinBrassAmount"))
        SoftSetArg("-anonymizebitcoinbrassamount", settings.value("nAnonymizeBitcoinBrassAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in bitcoinbrass.cpp during shotdown to also remove the window positions
