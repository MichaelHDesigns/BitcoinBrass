...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("BitcoinBrass Core"),
     ...
     * override -datadir in the bitcoinbrass.conf file in the default data directory
     * (to be consistent with bitcoinbrassd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
