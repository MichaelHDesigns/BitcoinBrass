                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzBRSPathCustom = GetArg("-zbrsbackuppath", "");
    ...
    if(!strzBRSPathCustom.empty()) {
        ui->wallet_customzbrsbackuppath->setText(QString::fromStdString(strzBRSPathCustom));
        ui->wallet_customzbrsbackuppath_label->setVisible(true);
        ui->wallet_customzbrsbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzBRSPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the BitcoinBrass RPC console.") + "<br>" +
