...
/** Utility functions used by the BitcoinBrass Qt UI.
 */
namespace GUIUtil
{
...
// Render BitcoinBrass addresses in monospace font
...
// Parse "bitcoinbrass:" URI into recipient object, return true on successful parsing
