...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BitcoinBrass Core bitcoinbrass-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bitcoinbrass-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitcoinbrass transaction") + "\n" +
                               "  bitcoinbrass-tx [options] -create [commands]   " + _("Create hex-encoded bitcoinbrass transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bitcoinbrass transaction
