...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop BitcoinBrass server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "BitcoinBrass server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BitcoinBrass features */
        {"bitcoinbrass", "listmasternodes", &listmasternodes, true, true, false},
        {"bitcoinbrass", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bitcoinbrass", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bitcoinbrass", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"bitcoinbrass", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"bitcoinbrass", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"bitcoinbrass", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bitcoinbrass", "masternodedebug", &masternodedebug, true, true, false},
        {"bitcoinbrass", "startmasternode", &startmasternode, true, true, false},
        {"bitcoinbrass", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bitcoinbrass", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bitcoinbrass", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bitcoinbrass", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bitcoinbrass", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bitcoinbrass", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bitcoinbrass", "preparebudget", &preparebudget, true, true, false},
        {"bitcoinbrass", "submitbudget", &submitbudget, true, true, false},
        {"bitcoinbrass", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bitcoinbrass", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bitcoinbrass", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bitcoinbrass", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bitcoinbrass", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bitcoinbrass", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bitcoinbrass", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bitcoinbrass", "checkbudgets", &checkbudgets, true, true, false},
        {"bitcoinbrass", "mnsync", &mnsync, true, true, false},
        {"bitcoinbrass", "spork", &spork, true, true, false},
        {"bitcoinbrass", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzbrsseed", &getzbrsseed, false, false, true},
        {"zerocoin", "setzbrsseed", &setzbrsseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzbrs", &searchdzbrs, false, false, true},
        {"zerocoin", "dzbrsstate", &dzbrsstate, false, false, true},
...
{
    return "> bitcoinbrass-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:51579/\n";
}
