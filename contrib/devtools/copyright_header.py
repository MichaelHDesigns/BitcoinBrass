...
EXCLUDE = [
    # auto generated:
    'src/qt/bitcoinbrassstrings.cpp',
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The BitcoinBrass developers'
...
Arguments:
    <base_directory> - The base directory of a bitcoinbrass source code repository.
"""
