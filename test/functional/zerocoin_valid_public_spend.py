...
from fake_stake.base_test import BitcoinBrass_FakeStakeTest

class zBRSValidCoinSpendTest(BitcoinBrass_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zBRSs..." % DENOM_TO_USE)
